...
import Underwriting from "../UW/UnderWriting/Underwriting";
  ...
  return (
    <Routes>
      <Route
        ...
        exact={true}
        render={(props) => <Underwriting {...props} />}
      />
      <Route
        path="/uw/underwriting/:id"
        exact={true}
        render={(props) => <UWDetail {...props} />}
      />
      <Route
        path="/uw/policy"
        exact={true}
        render={(props) => <UWPolicy {...props} />}
      />
      <Route
        path="/uw/policy/addpolicy"
        exact={true}
        render={(props) => <AddUWPolicy {...props} />}
      />
      <Route
        path="/uw/policy/:id"
        exact={true}
        render={(props) => <UWPolicyDetail {...props} />}
      />
      <Route
        path="/uw/lossmanage"
        exact={true}
